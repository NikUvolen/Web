...
const bgPath = '/static/novella/images/bg/';
const chrPath = '/static/novella/images/characters/';
...
function updateScene() {
    ...
    backgroundElement.style.backgroundImage = `url(${bgPath + scene.background})`;

    secondCharacter.innerHTML = '';
    if (scene.secondCharacter) {
        const secondCharacterImg = document.createElement('img');
        secondCharacterImg.src = chrPath + characters[scene.secondCharacter].link;
